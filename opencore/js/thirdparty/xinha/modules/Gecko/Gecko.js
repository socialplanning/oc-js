  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --   that way.
    --
    --  $HeadURL: http://svn.xinha.webfactional.com/branches/0.95_stable/modules/Gecko/Gecko.js $
...
Gecko._pluginInfo = {
  ...
  developer_url : "$HeadURL: http://svn.xinha.webfactional.com/branches/0.95_stable/modules/Gecko/Gecko.js $".replace(/^[^:]*: (.*) \$$/, '$1'),
  sponsor       : "",
  sponsor_url   : "",
  license       : "htmlArea"
};
