  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --
    --
    --  $HeadURL: http://svn.xinha.webfactional.com/branches/0.95_stable/modules/InsertImage/insert_image.js $
    --  $LastChangedDate: 2007-10-10 16:08:24 -0500 (Wed, 10 Oct 2007) $
...
InsertImage._pluginInfo = {
  ...
  developer_url : "$HeadURL: http://svn.xinha.webfactional.com/branches/0.95_stable/modules/InsertImage/insert_image.js $".replace(/^[^:]*: (.*) \$$/, '$1'),
  sponsor       : "",
  sponsor_url   : "",
  license       : "htmlArea"
};
