  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --
    --
    --  $HeadURL: http://svn.xinha.webfactional.com/branches/0.95_stable/modules/CreateLink/link.js $
    --  $LastChangedDate: 2007-01-23 08:26:04 -0600 (Tue, 23 Jan 2007) $
...
CreateLink._pluginInfo = {
  ...
  developer_url : "$HeadURL: http://svn.xinha.webfactional.com/branches/0.95_stable/modules/CreateLink/link.js $".replace(/^[^:]*: (.*) \$$/, '$1'),
  sponsor       : "",
  sponsor_url   : "",
  license       : "htmlArea"
};
