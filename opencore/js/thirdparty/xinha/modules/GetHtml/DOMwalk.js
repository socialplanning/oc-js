  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --
    --
    --  $HeadURL: http://svn.xinha.webfactional.com/branches/0.95_stable/modules/GetHtml/DOMwalk.js $
...
GetHtmlImplementation._pluginInfo = {
  ...
  developer_url : "$HeadURL: http://svn.xinha.webfactional.com/branches/0.95_stable/modules/GetHtml/DOMwalk.js $".replace(/^[^:]*: (.*) \$$/, '$1'),
  sponsor       : "",
  sponsor_url   : "",
  license       : "htmlArea"
};
