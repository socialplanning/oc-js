  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --   namespace that way.
    --
    --  $HeadURL: http://svn.xinha.webfactional.com/branches/0.95_stable/modules/InternetExplorer/InternetExplorer.js $
    --  $LastChangedDate: 2008-02-04 11:45:53 -0600 (Mon, 04 Feb 2008) $
...
InternetExplorer._pluginInfo = {
  ...
  origin        : "Xinha Core",
  version       : "$LastChangedRevision: 964 $".replace(/^[^:]*: (.*) \$$/, '$1'),
  developer     : "The Xinha Core Developer Team",
  developer_url : "$HeadURL: http://svn.xinha.webfactional.com/branches/0.95_stable/modules/InternetExplorer/InternetExplorer.js $".replace(/^[^:]*: (.*) \$$/, '$1'),
  sponsor       : "",
  sponsor_url   : "",
  license       : "htmlArea"
};
